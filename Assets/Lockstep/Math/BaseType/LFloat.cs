...
namespace Lockstep.Math {
    ...
    public struct LFloat : IEquatable<LFloat>, IComparable<LFloat> {
        ...
        public static LFloat FromTen(int ten)
        {
            return new LFloat(null, ten * 100);
        }

        public static LFloat FromHundred(int hundred)
        {
            return new LFloat(null, hundred * 10);
        }

        public static LFloat FromThousand(int thousand)
        {
            return new LFloat(null, thousand);
        }
